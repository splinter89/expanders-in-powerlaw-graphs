...
\begin{table}
    ...
    \begin{center}
        ...
        \begin{tabular}{|l|c|c|c|c|c|c|}
            ...
            \cline{1-7}
            \#vertices, $n$ & $\frac{e^{\alpha/\beta}}{1-\beta}$ & $\alpha e^\alpha$ & \multicolumn{4}{|c|}{$\zeta(\beta)e^\alpha$}\rule{0pt}{21pt}\\[0.7em]
            \cline{1-7}
            \#edges & \multicolumn{3}{|c|}{$\frac{1}{2}\frac{e^{2\alpha/\beta}}{2-\beta}$} & $\frac{1}{4}\alpha e^\alpha$ & \multicolumn{2}{|c|}{$\frac{1}{2}\zeta(\beta-1)e^\alpha$}\rule{0pt}{21pt}\\[0.7em]
            \hline
        \end{tabular}
